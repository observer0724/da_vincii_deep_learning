...
for i in range(7):
    ...
    F6_units = 84
    F7_units = 2
    folder = str(patch_size)+'*'+str(patch_size)
    os.mkdir('/home/observer0724/Desktop/da_vincii/'+folder+'/')
    graph = tf.Graph()
    ...
    with graph.as_default():
        ...
        with tf.name_scope('fc1'):
            C5_weights = tf.Variable(tf.truncated_normal([ (52- patch_size)* (52- patch_size)* depth2 /4, C5_units], stddev=0.1), name = 'C5_weights')
    ...
    writer = tf.train.SummaryWriter('/home/observer0724/Desktop/da_vincii/board/'+folder+'/',sess.graph)
    with sess as session:
      ...
      for step in range(num_steps):
        ...
        if (step % 10 == 0):
            f=open('/home/observer0724/Desktop/da_vincii/'+folder+'/record.txt','a')
      ...
      f.write('\n')
      f.close()
      save_path = saver.save(session, "/home/observer0724/Desktop/da_vincii/"+folder+"/damodel.ckpt")
